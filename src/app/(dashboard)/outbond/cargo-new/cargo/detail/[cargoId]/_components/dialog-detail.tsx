...
import { useRemoveProductCargo } from "../_api/use-remove-product-cargo";
import { useGetDetailBagCargo } from "../_api/use-get-detail-bag-cargo";
        ...
        {isLoading ? (
          ...
          <div className="w-full flex flex-col gap-5 mt-5 overflow-y-auto">
            ...
            <DataTable
              isSticky
              isLoading={isLoading}
              columns={columnCargoDetailBag(handleRemoveProduct, isPendingRemove)}
